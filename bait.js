...
function bait__ast__Table_register_sym(t, sym) {
	...
	if (idx > 0) {
		...
		} else if (Array_contains(bait__ast__BUILTIN_STRUCT_TYPES, idx)) {
			let new_sym = sym
...
const bait__util__FULL_VERSION = from_js_string(`${bait__util__VERSION.str} ${from_js_string("3bda9ed").str}`)
